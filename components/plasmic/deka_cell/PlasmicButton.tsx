...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OZSqee0ES_HTq_B/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg___9IQr)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <AppleIcon
                className={classNames(projectcss.all, sty.svg__gymDz)}
                role={"img"}
              />
            ),
