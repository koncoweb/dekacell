...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: AbM8sTfPTZeKgDz/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          image: {
            src: "/plasmic/deka_cell/images/meeting.jpg",
            fullWidth: 2916,
            fullHeight: 1787,
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__g5Jle)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__v1CxT)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___1H2Cf)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__fGqU)}
                    >
                      <Button
                        className={classNames(
                          "__wab_instance",
