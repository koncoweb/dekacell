...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: Rxz1zU5HS7x0VsX/css
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg__p8YcK)}
            role={"img"}
          />
        ),
